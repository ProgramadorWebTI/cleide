...
if(isset($_POST['nome']))
	{
		...
		$resultado = editarUsuario($nome,$numero_habilitacao,$identidade,$data_nasc,$nacionalidade,$naturalidade,$uf,$exame_sanidade,$habilitacao_para_categoria,$data_solicitacao_da_emissao,$data_de_habilitacao,$obs_cng,$obs_bloqueio,$obs_detran,$cpf,$email,$id);

		if($resultado == true)
		{
			$_SESSION['mensagem'] = '<span class="text text-success text-center">Usuário atualizado com sucesso!</span>';
			header("location:./../admin.php");
		}
		else
		{
			$_SESSION['mensagem'] = '<span class="text text-danger text-center">Error, não foi possivel atualizar usuário!</span>';
			header("location:./../admin.php");
		}
	}
